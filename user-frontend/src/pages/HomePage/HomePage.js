      ...
      <main className={`bg-black ${styles.main}`}>
        <div className={styles.container}>
          ...
          <p className={styles.main_paragraph}>
            Finding the perfect group of travel buddies to go on an adventure
            with has never been easier. Join a travel group or create your own
            to go on adventures with like-minded men you identify with the most.
            We host adventures designed for all fitness levels.
            <br />
            <br />
            Our community has grown to make real hands on change in the world
            through our affiliated wildlife and environmental conservation
            projects. We are proud that we can assist and bring awareness to
            these much needed causes and celebrate our brotherhood of positive
            change.
          </p>
          ...
          <div className={styles.how_section_container}>
            ...
            <div>
              <p>
                ...
                you that we are the matchmaker for trips and like-minded people?
                Well that's exactly what we are. After you register we will able
                to match you with like-minded men with similar travel interests.
              </p>
              <button
                ...
                <>
                  ...
                  <ul>
                    ...
                    <li className={styles.see_more_list_item}>
                      ...
                      create your own travel group, select your prefered travel
                      dates and then invite members of the Man Ex community who
                      share the same travel interests as you.
                    </li>
                  </ul>
                </>
              )}
          ...
          <div className={styles.impact_section_blobs_container}>
            <div className={styles.impact_section_blob}>
              ...
              <p className={styles.impact_section_blob_text}>
                AVERAGE HATCHED ON BEACHS THAT THE PROCEEDS FROM OUR TRIPS HELP
                KEEP CLEAN AND SAFE
              </p>
            </div>
            <div className={styles.impact_section_blob}>
              ...
              <p className={styles.impact_section_blob_text}>
                OF CONSERVATION LAND SUPPORTED FROM THE PROCEEDS OF OUR TRIPS
              </p>
            </div>
            <div className={styles.impact_section_blob}>
              <img
                ...
                alt="Rhino."
              />
              <h4 className={styles.impact_section_blob_title}>23 Rhinos</h4>
              <p className={styles.impact_section_blob_text}>
